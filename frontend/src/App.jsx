...
export default function App() {
  ...
  const executeImageScan = async () => {
    ...
    form.append('confidence_threshold', String(settings.confidence));
    ...
    form.append('patch_overlap',        settings.mode === 'Performance' ? '0.0' : '0.25');
    form.append('inference_strategy',   'Auto');
    form.append('model_type',           'P2PNet');
    ...
    try {
      ...
      ws.onopen = () => {
        ...
        ws.send(JSON.stringify({
          settings: {
            confidenceThresh: parseFloat(settings.confidence),
              ...
              <div className="slider-header">
                ...
                <span className="slider-value">
                  {isInt
                    ...
                    : parseFloat(settings[key]).toFixed(2)}{suffix}
                </span>
              </div>
